...
class MCSimulation:
    ...
    def summarize_cumulative_return(self):
        ...
        metrics = pd.DataFrame(self.simulated_return.iloc[-1].describe())
        ci_series = pd.DataFrame(self.confidence_interval.values,index=["95% CI Lower","95% CI Upper"],columns=metrics.columns)
